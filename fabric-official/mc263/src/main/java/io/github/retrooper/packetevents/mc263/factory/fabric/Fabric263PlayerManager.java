...
package io.github.retrooper.packetevents.mc263.factory.fabric;
...
public class Fabric263PlayerManager extends AbstractFabricPlayerManager {

    public Fabric263PlayerManager(PacketEventsAPI<?> packetEventsAPI) {
