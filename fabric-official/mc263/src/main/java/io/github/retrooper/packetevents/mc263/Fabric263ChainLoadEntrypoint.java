package io.github.retrooper.packetevents.mc263;
...
import io.github.retrooper.packetevents.mc263.factory.fabric.Fabric263PlayerManager;
import io.github.retrooper.packetevents.util.LazyHolder;
import org.jetbrains.annotations.Nullable;

public class Fabric263ChainLoadEntrypoint implements ChainLoadEntryPoint {

    private final LazyHolder<AbstractFabricPlayerManager> playerManager =
            LazyHolder.simple(() -> new Fabric263PlayerManager(FabricPacketEventsAPI.getServerAPI()));
